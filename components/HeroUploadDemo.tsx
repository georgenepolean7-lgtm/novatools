...
export default function HeroUploadDemo() {
  return (
    <motion.div
      ...
      className="relative isolate w-full max-w-md overflow-hidden rounded-[32px] border border-cyan-400/20 bg-white/[0.08] p-6 shadow-[0_20px_80px_rgba(0,0,0,.45)] backdrop-blur-2xl"
    >
      {/* Glow */}
      {/* Blue Aura */}
...
<div className="absolute bottom-0 left-1/2 h-20 w-56 -translate-x-1/2 rounded-full bg-cyan-400/10 blur-3xl" />
      ...
      <div className="relative z-10">
        ...
        <motion.div
          ...
          className="mt-6 flex items-center gap-3 rounded-2xl bg-emerald-500/15 border border-emerald-400/20 p-4"
        >
        ...
        <motion.div
          ...
          className="absolute -right-8 -top-8 rounded-2xl bg-cyan-500/20 p-4 backdrop-blur-xl"
        >
